...
export const SAMPLE_REVIEWS: SampleReviewConfig[] = [
  {
    ...
    explanation: 'The contract deterministically chunked the document into 3 blocks, grounded the verbatim refund quote, and verified all criteria satisfied across validator consensus.',
  },
  {
    id: '60932b48_d101aeae_r1',
    title: 'Immediate Violation',
    subtitle: 'Auto-renewal trap detected in chunk 1',
    ...
    expectedCoverageBp: 10000,
    explanation: 'Contains an automatic perpetual renewal trap in the opening sections. Even naive prefix-only tools catch this, but FullRead provides on-chain verifiable quotes and consensus proof.',
  },
  {
    id: '60932b48_abac5b2d_r1',
    title: 'Buried Trap Clause',
    subtitle: 'Adverse clause hidden on page 3 / chunk 3',
    ...
    expectedOutcome: 'FAIL',
    expectedCoverageBp: 10000,
    explanation: 'The star test: The document appears 100% compliant across chunks 1 and 2, but buries a perpetual auto-renewal trap deep inside chunk 3. Conventional truncated audits issue a false PASS; FullRead catches it with 10,000 bp coverage.',
  },
];
